...
;(function () {
  ...
  function updateFormProgress() {
    ...
    console.log(
      `[SecureShop] Form progress: ${completedForms}/${totalForms} (${progress.toFixed(0)}%)`
    )
  }
  ...
  function setupDevelopmentHelpers() {
    ...
    console.log(
      '[SecureShop] Development helpers available: SecureShop.fillTestData(), SecureShop.validateAllForms(), SecureShop.getOrderData(), SecureShop.clearAllForms()'
    )
  }
