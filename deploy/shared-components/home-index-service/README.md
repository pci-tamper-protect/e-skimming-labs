...
The home index service provides the main landing page for the E-Skimming Labs platform, featuring:

## Features

- **Interactive Lab Directory**: Lists all available labs with detailed descriptions
- **MITRE ATT&CK Integration**: Direct access to the MITRE ATT&CK matrix for e-skimming attacks
...
This service is deployed as part of the `labs-home-prd` project using Cloud Run. The Docker image includes the MITRE ATT&CK and threat model HTML files from the `docs/` directory.
