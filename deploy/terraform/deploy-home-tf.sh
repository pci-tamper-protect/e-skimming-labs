...
echo ""
echo "📋 Next steps:"
echo "1. Create the service account key for GitHub Actions (NOT managed by Terraform):"
echo "   gcloud iam service-accounts keys create /tmp/home-deploy-key.json \\"
echo "     --iam-account=home-deploy-sa@${PROJECT_ID}.iam.gserviceaccount.com \\"
...
echo "   gh secret set GCP_HOME_SA_KEY --body \"\$(cat /tmp/home-deploy-key.json | base64)\""
echo "   rm /tmp/home-deploy-key.json"
