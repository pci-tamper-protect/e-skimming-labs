...
get_lab_labels() {
  ...
  case "$service" in
    ...
    lab3-vulnerable-site)
      ...
      ;;
    shared-c2)
      labels="traefik_enable=true,traefik_http_routers_lab1-c2-collect_rule_id=lab1-c2-collect,traefik_http_routers_lab1-c2-collect_priority=450,traefik_http_routers_lab1-c2-collect_entrypoints=web,traefik_http_routers_lab1-c2-collect_service=shared-c2,traefik_http_routers_lab1-c2_rule_id=lab1-c2,traefik_http_routers_lab1-c2_priority=300,traefik_http_routers_lab1-c2_entrypoints=web,traefik_http_routers_lab1-c2_middlewares=strip-passthrough-prefix-file,traefik_http_routers_lab1-c2_service=shared-c2,traefik_http_routers_lab2-c2-collect_rule_id=lab2-c2-collect,traefik_http_routers_lab2-c2-collect_priority=450,traefik_http_routers_lab2-c2-collect_entrypoints=web,traefik_http_routers_lab2-c2-collect_service=shared-c2,traefik_http_routers_lab2-c2_rule_id=lab2-c2,traefik_http_routers_lab2-c2_priority=400,traefik_http_routers_lab2-c2_entrypoints=web,traefik_http_routers_lab2-c2_middlewares=strip-passthrough-prefix-file__lab2-auth-check-file,traefik_http_routers_lab2-c2_service=shared-c2,traefik_http_routers_lab3-c2-collect_rule_id=lab3-c2-collect,traefik_http_routers_lab3-c2-collect_priority=450,traefik_http_routers_lab3-c2-collect_entrypoints=web,traefik_http_routers_lab3-c2-collect_service=shared-c2,traefik_http_routers_lab3-extension_rule_id=lab3-extension,traefik_http_routers_lab3-extension_priority=400,traefik_http_routers_lab3-extension_entrypoints=web,traefik_http_routers_lab3-extension_middlewares=strip-passthrough-prefix-file__lab3-auth-check-file,traefik_http_routers_lab3-extension_service=shared-c2,traefik_http_routers_lab4-c2-collect_rule_id=lab4-c2-collect,traefik_http_routers_lab4-c2-collect_priority=450,traefik_http_routers_lab4-c2-collect_entrypoints=web,traefik_http_routers_lab4-c2-collect_service=shared-c2,traefik_http_routers_lab4-c2_rule_id=lab4-c2,traefik_http_routers_lab4-c2_priority=300,traefik_http_routers_lab4-c2_entrypoints=web,traefik_http_routers_lab4-c2_middlewares=strip-passthrough-prefix-file__lab4-auth-check-file,traefik_http_routers_lab4-c2_service=shared-c2,traefik_http_routers_lab5-c2-collect_rule_id=lab5-c2-collect,traefik_http_routers_lab5-c2-collect_priority=450,traefik_http_routers_lab5-c2-collect_entrypoints=web,traefik_http_routers_lab5-c2-collect_service=shared-c2,traefik_http_routers_lab5-c2_rule_id=lab5-c2,traefik_http_routers_lab5-c2_priority=300,traefik_http_routers_lab5-c2_entrypoints=web,traefik_http_routers_lab5-c2_middlewares=strip-passthrough-prefix-file__lab5-auth-check-file,traefik_http_routers_lab5-c2_service=shared-c2,traefik_http_services_shared-c2_lb_port=8080"
      ;;
    ...
    lab5-vulnerable-site)
      labels="traefik_enable=true,traefik_http_routers_lab5-health_rule_id=lab5-health,traefik_http_routers_lab5-health_priority=400,traefik_http_routers_lab5-health_entrypoints=web,traefik_http_routers_lab5-health_middlewares=strip-lab5-prefix-file,traefik_http_routers_lab5-health_service=lab5-vulnerable-site,traefik_http_routers_lab5-static_rule_id=lab5-static,traefik_http_routers_lab5-static_priority=250,traefik_http_routers_lab5-static_entrypoints=web,traefik_http_routers_lab5-static_middlewares=strip-lab5-prefix-file,traefik_http_routers_lab5-static_service=lab5-vulnerable-site,traefik_http_routers_lab5-main_rule_id=lab5-main,traefik_http_routers_lab5-main_priority=200,traefik_http_routers_lab5-main_entrypoints=web,traefik_http_routers_lab5-main_middlewares=lab5-auth-check-file__strip-lab5-prefix-file,traefik_http_routers_lab5-main_service=lab5-vulnerable-site,traefik_http_services_lab5-vulnerable-site_lb_port=8080"
      ;;
    *)
